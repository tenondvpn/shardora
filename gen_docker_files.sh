...
cp -rf ./shardoras/shardora/GeoLite2-City.mmdb ./docker_files/node/conf
cp -rf ./shardoras/shardora/conf/log4cpp.properties ./docker_files/node/conf
...
cp -rf /root/shardoras/shardora/root_db ./docker_files/node/
cp -rf /root/shardoras/shardora/shard_db_* ./docker_files/node/
