...
then
	...
	sudo mv -f /tmp/zjchain /home/xl/zjnodes/zjchain
fi
root=("r1" "r2" "r3")
...
sudo cp -rf ./cbuild_$TARGET/zjchain /home/xl/zjnodes/zjchain/xlchain
sudo cp -f ./conf/genesis.yml /home/xl/zjnodes/zjchain/genesis.yml

# for node in "${nodes[@]}"; do
    # sudo cp -rf ./cbuild_$TARGET/zjchain /home/xl/zjnodes/${node}/xlchain
# done
sudo cp -rf ./cbuild_$TARGET/zjchain /home/xl/zjnodes/zjchain/xlchain
...
if test $NO_BUILD = 0
then
    cd /home/xl/zjnodes/zjchain && ./xlchain -U
    cd /home/xl/zjnodes/zjchain && ./xlchain -S 3 &
    wait
fi
