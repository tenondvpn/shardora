...
private:
    ...
    evmc::VM evm_;
    common::UniqueSet<std::string, 10000, 16> address_exists_set_[common::kMaxThreadCount];
    common::UniqueMap<std::string, std::string, 20000, 16> storage_map_[common::kMaxThreadCount];
