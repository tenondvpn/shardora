...
int ContractUserCreateCall::HandleTx(
    ...
    ZJC_DEBUG("create contract called %s, user: %s, prepament: %lu, gas used: %lu, gas_price: %lu",
        common::Encode::HexEncode(block_tx.to()).c_str(),
...
int ContractUserCreateCall::SaveContractCreateInfo(
    ...
    zjc_host.SavePrevStorages(protos::kCreateContractBytesCode, zjc_host.create_bytes_code_);
