...
private:
    ...
    Status HandleProposeMsgStep_VerifyTC(ProposeMsgWrapper& pro_msg_wrap) {
        // 3 Verify TC
    ...
    Status HandleProposeMsgStep_VerifyQC(ProposeMsgWrapper& pro_msg_wrap) {
    ...
    Status HandleProposeMsgStep_VerifyViewBlockAndCommit(ProposeMsgWrapper& pro_msg_wrap) {
        // 4 Verify ViewBlock    
        if (VerifyViewBlock(
    ...
    Status HandleProposeMsgStep_TxAccept(ProposeMsgWrapper& pro_msg_wrap) {
    ...
    Status HandleProposeMsgStep_ChainStore(ProposeMsgWrapper& pro_msg_wrap) {
        // 6 add view block
    ...
    Status HandleProposeMsgStep_Vote(ProposeMsgWrapper& pro_msg_wrap) {
