...
static const uint32_t kConsensusShardEndNetworkId = 4u;
static const uint32_t kConsensusWaitingShardOffset = kConsensusShardEndNetworkId - kRootCongressNetworkId + 1;
