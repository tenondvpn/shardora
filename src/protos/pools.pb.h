...
class ToTxMessageItem : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:zjchain.pools.protobuf.ToTxMessageItem) */ {
 public:
  ...
  ::google::protobuf::uint64 amount(int index) const;
  void set_amount(int index, ::google::protobuf::uint64 value);
  void add_amount(::google::protobuf::uint64 value);
  const ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >&
      amount() const;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >*
      mutable_amount();
 ...
 private:
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint64 > amount_;
...
// repeated uint64 amount = 2;
inline int ToTxMessageItem::amount_size() const {
  return amount_.size();
}
inline void ToTxMessageItem::clear_amount() {
  amount_.Clear();
}
inline ::google::protobuf::uint64 ToTxMessageItem::amount(int index) const {
  // @@protoc_insertion_point(field_get:zjchain.pools.protobuf.ToTxMessageItem.amount)
  return amount_.Get(index);
}
inline void ToTxMessageItem::set_amount(int index, ::google::protobuf::uint64 value) {
  amount_.Set(index, value);
  // @@protoc_insertion_point(field_set:zjchain.pools.protobuf.ToTxMessageItem.amount)
}
inline void ToTxMessageItem::add_amount(::google::protobuf::uint64 value) {
  amount_.Add(value);
  // @@protoc_insertion_point(field_add:zjchain.pools.protobuf.ToTxMessageItem.amount)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >&
ToTxMessageItem::amount() const {
  // @@protoc_insertion_point(field_list:zjchain.pools.protobuf.ToTxMessageItem.amount)
  return amount_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >*
ToTxMessageItem::mutable_amount() {
  // @@protoc_insertion_point(field_mutable_list:zjchain.pools.protobuf.ToTxMessageItem.amount)
  return &amount_;
}
