...
const contract_address = "48e1eab96c9e759daa3aff82b40e77cd615a41d6";
...
function CreatePrivateAndPublicKeys(id) {
    var key = "tpinit"
    ...
    var addParam = web3.eth.abi.encodeParameters(
        ['bytes32', 'bytes'], 
        ['0x' + id, hexparam]);
    var addParamCode = web3.eth.abi.encodeFunctionSignature('CreatePrivateAndPublicKeys(bytes32,bytes)');
    console.log("addParam 0: " + key + ":" + value + "," + addParamCode.substring(2) + addParam.substring(2));
    call_contract(
        "cefc2c33064ea7691aee3e5e4f7842935d26f3ad790d81cf015e79b78958e848", 
        addParamCode.substring(2) + addParam.substring(2), 0);
...
function CreateReEncryptionKeys(id) {
    var key = "tprenk"
    ...
    var addParam = web3.eth.abi.encodeParameters(
        ['bytes32', 'bytes'], 
        ['0x' + id, hexparam]);
    var addParamCode = web3.eth.abi.encodeFunctionSignature('CreateReEncryptionKeys(bytes32,bytes)');
    console.log("addParam 0: " + key + ":" + value + "," + addParamCode.substring(2) + addParam.substring(2));
    call_contract(
        "cefc2c33064ea7691aee3e5e4f7842935d26f3ad790d81cf015e79b78958e848", 
        addParamCode.substring(2) + addParam.substring(2), 0);
...
function EncryptUserMessage(id) {
    var key = "tpencu"
    var value = id+";";
    var key_len = key.length.toString();
    if (key.length <= 9) {
    ...
    var addParam = web3.eth.abi.encodeParameters(
        ['bytes32', 'bytes'], 
        ['0x' + id, hexparam]);
    var addParamCode = web3.eth.abi.encodeFunctionSignature('EncryptUserMessage(bytes32,bytes)');
    console.log("addParam 0: " + key + ":" + value + "," + addParamCode.substring(2) + addParam.substring(2));
    call_contract(
        "cefc2c33064ea7691aee3e5e4f7842935d26f3ad790d81cf015e79b78958e848", 
        addParamCode.substring(2) + addParam.substring(2), 0);
...
function ReEncryptUserMessage(id) {
    var key = "tprenc"
    var value = id+";";
    var key_len = key.length.toString();
    if (key.length <= 9) {
    ...
    var addParam = web3.eth.abi.encodeParameters(
        ['bytes32', 'bytes'], 
        ['0x' + id, hexparam]);
    var addParamCode = web3.eth.abi.encodeFunctionSignature('ReEncryptUserMessage(bytes32,bytes)');
    console.log("addParam 0: " + key + ":" + value + "," + addParamCode.substring(2) + addParam.substring(2));
    call_contract(
        "cefc2c33064ea7691aee3e5e4f7842935d26f3ad790d81cf015e79b78958e848", 
        addParamCode.substring(2) + addParam.substring(2), 0);
...
function ReEncryptUserMessageWithMember(id, index) {
    var key = "mprenc"
    var value = id+";"+index;
    var key_len = key.length.toString();
    if (key.length <= 9) {
    ...
    var addParam = web3.eth.abi.encodeParameters(
        ['bytes32', 'bytes'], 
        ['0x' + id, hexparam]);
    var addParamCode = web3.eth.abi.encodeFunctionSignature('ReEncryptUserMessageWithMember(bytes32,bytes)');
    console.log("addParam 0: " + key + ":" + value + "," + addParamCode.substring(2) + addParam.substring(2));
    call_contract(
        "cefc2c33064ea7691aee3e5e4f7842935d26f3ad790d81cf015e79b78958e848", 
        addParamCode.substring(2) + addParam.substring(2), 0);
...
function Decryption(id) {
    ...
    var addParam = web3.eth.abi.encodeParameters(
        ['bytes32', 'bytes'], 
        ['0x' + id, hexparam]);
    var addParamCode = web3.eth.abi.encodeFunctionSignature('Decryption(bytes32,bytes)');
    console.log("addParam 0: " + key + ":" + value + "," + addParamCode.substring(2) + addParam.substring(2));
    call_contract(
        "cefc2c33064ea7691aee3e5e4f7842935d26f3ad790d81cf015e79b78958e848", 
        addParamCode.substring(2) + addParam.substring(2), 0);
...
if (args[0] == 1) {
    // add_pairing_param("tpinit", "tpinit", id+";29eb86b7292ce572e46c6bdf8d8639dc6918991b,5b88d2cc46b94f199d12ff3c050c2db337871051,792e703d820ee43e5014803297208e7a774ceaa5,713b6605d93f07badf314cafe941ba2c4c6ad4bc,52a888b6437f8ebde99ec8929ff3f0f1fa533ad5,01a9a0ad9d65bcf47bb3326da7fd2aef8c18ea88,55c6b8dd50c1430969022788787d972848158c46,19b65ddc3cafa7942e5ac54394f09f1990ca2ac7,19d981de4f615ab95e61553421c358b96e997a2c,7bdc787d0aaddf760eab83de971028712123f1ca");
    CreatePrivateAndPublicKeys(id);
    print(id)
}

// RKGen：重加密密钥生成，需要用到pbc库
if (args[0] == 2) {
    // add_pairing_param("tprenk", "tprenk", id+";468a50340bc016c5161df8a40dd7890a84132750,204be12c7d5a77f4cecca96aeb1aadd0dc11e829,4d84890349d26fa23fb94ee32d16a4a522025072,4855a79cbcfc3d54cd99d504872beee01c8f9096,543cf9eec69613a4a01c28ebe64e50fbe234b57f,026047a338ee52e99f611bd02e9e5b12ecb83b74,35c95955d7bca26ccea47b3bf1aacc5936b53c5a,5e1694b4226bd0e1b75b71a249d6126c87d14a9e,48d9915add7e5bf58e5ad8adef850fb899c3d6ea,166ab66ee71d78d357c2c69697267c30fb820c65\n578997ffbf36d620eabeed6c6462090bf4850063,1ca9d6839beec8a8ae44aa717b217ea49929333d,6f20963912e7b78aba3a27850a53e2d2898d156d\n77f1868888fea3dc4cf479b9fed840c50e7b80e6,1c4bdf20371da32c30499e0e46438dcd0f829c21,3029b3818313522b65700c0bfaffe8741acfd1de\,,,,,,,,\n4eb24680d02ab2ba45ef78e8b425f7c94eb662d0,3545ad3b3fe0c2f4c08a900eae3d03c87969ba6c,336293b77152b9e4d718481c6153c2d4369561b5,578e3eb7048153b05577276a0b1c1059140be7c9,604e8223208efb81daa9778237fa75fc22344a1c,138eb8b0d8c6073a080179935b8b9b92d00c589b,0f2ea3cf55743836fbbf9a5756a524be3adb1c78,247922d501351bfea6ab14bab95cf0cf912ef84e,78cddbd9d4299c953cfa839feac915e0bcdf7bce");
    CreateReEncryptionKeys(id);
}

// Upd：token更新算法，需要用到pbc库
if (args[0] == 3) {
    // add_pairing_param("tpencu", "tpencu", id+";tpencu");
    EncryptUserMessage(id);
}

// ReEnc：重加密，需要用到pbc库 (这一步包含一个分布式随机数生成协议，即多个代理协商出一个统一的随机数)
if (args[0] == 4) {
    // add_pairing_param("tprenc", "tprenc", id+";tprenc");
    ReEncryptUserMessage(id);
}
