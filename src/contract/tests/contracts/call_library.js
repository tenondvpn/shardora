...
var call_claimPaiment_func_code = web3.eth.abi.encodeFunctionSignature('getSum(uint, uint)');
var call_claimPaiment_param_codes = web3.eth.abi.encodeParameters(['uint', 'uint'], ['2643000000', '1']);
