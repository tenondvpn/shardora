...
module.exports = {
  encode: __webpack_require__(10),
  decode: __webpack_require__(11),
  encodingLength: __webpack_require__(12)
};
...
const intTable = __webpack_require__(13);

const codecNameToCodeVarint = __webpack_require__(14);
...
exports.print = __webpack_require__(16);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(1).Buffer))
...
const baseTable = __webpack_require__(0); // map for hexString -> codecName
...
const baseTable = __webpack_require__(0);

const varintEncode = __webpack_require__(3).varintEncode; // map for codecName -> codeVarintBuffer
...
const table = __webpack_require__(0); // map for codecConstant -> code
...
const table = __webpack_require__(0); // map for code -> print friendly name
