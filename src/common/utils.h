...
enum MessageType {
    ...
    kContractMessage = 7,
    kBlockMessage = 8,
    kConsensusTimerMessage = 9,
    kPoolTimerMessage = 10,
    kInitMessage = 11,
    kC2cMessage = 12,
    kHotstuffMessage = 13,
    kHotstuffSyncTimerMessage = 14,
    kPacemakerTimerMessage = 15,
    // max (message) type
...
static const int64_t kRotationPeriod = 240ll * 1000ll * 1000ll; // for quicker debugging
