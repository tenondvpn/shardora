...
sshpass -p $pass ssh -f -o StrictHostKeyChecking=no root@192.168.0.3 bash -c "'\
cd /root/load_test && ./txcli 0 3 15 192.168.0.3 13003 10 &
cd /root/load_test && ./txcli 0 4 15 192.168.0.3 14003 10 &
wait \
'"

./txcli 0 3 9 192.168.0.2 13002 10 &
./txcli 0 4 12 192.168.0.2 14002 10 &
