...
def gen_run_nodes_sh_file(server_conf: dict, file_path, build_genesis_path, tag, datadir='/home/xl', medium_server_num=-1):
    code_str = """
#!/bin/bash
# 修改配置文件
# 确保服务器安装了 sshpass
...
def main():
    ...
    parser.add_argument('--datadir', help='datadir', default='/home/xl')
