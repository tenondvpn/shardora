...
server103=10.0.0.84
server104=10.0.0.48
server105=10.0.0.112
server106=10.0.0.96
server107=10.0.0.115
server108=10.0.0.101
server109=10.0.0.50
server110=10.0.0.25
server111=10.0.0.35
server112=10.0.0.6
...
echo "[$server9]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server9 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server12]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server12 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server16]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server16 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server22]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server22 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF

echo "[$server23]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server23 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server26]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server26 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server29]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server29 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF

echo "[$server30]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server30 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF

echo "[$server31]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server31 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server33]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server33 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server46]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server46 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server51]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server51 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF

echo "[$server52]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server52 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server60]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server60 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF

echo "[$server61]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server61 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server65]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server65 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server67]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server67 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server71]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server71 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server76]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server76 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server94]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server94 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server100]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server100 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server103]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server103 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server105]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server105 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF

echo "[$server106]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server106 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF

echo "[$server107]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server107 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF

echo "[$server108]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server108 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server115]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server115 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
echo "[$server118]"
sshpass -p '' ssh -o StrictHostKeyChecking=no root@$server118 <<"EOF"
ps -ef | grep zjchain | grep mnt | awk -F' ' '{print $2}' | xargs kill -9
EOF
...
cd /mnt && sh -x fetch.sh 127.0.0.1 ${server0} 'Xf4aGbTaf!' '/mnt' r1 s3_118 s3_238 s3_358 s3_478 s3_598
echo "==== 同步中继服务器 ====" 
...
cd /mnt && sh -x fetch.sh ${server0} ${server1} 'Xf4aGbTaf!' '/mnt' s3_15 s3_135 s3_255 s3_375 s3_495;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server0} ${server2} 'Xf4aGbTaf!' '/mnt' s3_24 s3_144 s3_264 s3_384 s3_504;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server0} ${server3} 'Xf4aGbTaf!' '/mnt' s3_39 s3_159 s3_279 s3_399 s3_519;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server0} ${server4} 'Xf4aGbTaf!' '/mnt' s3_70 s3_190 s3_310 s3_430 s3_550;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server0} ${server5} 'Xf4aGbTaf!' '/mnt' s3_22 s3_142 s3_262 s3_382 s3_502;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server0} ${server6} 'Xf4aGbTaf!' '/mnt' s3_3 s3_123 s3_243 s3_363 s3_483;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server0} ${server7} 'Xf4aGbTaf!' '/mnt' s3_50 s3_170 s3_290 s3_410 s3_530;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server0} ${server8} 'Xf4aGbTaf!' '/mnt' s3_80 s3_200 s3_320 s3_440 s3_560;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server0} ${server9} 'Xf4aGbTaf!' '/mnt' s3_68 s3_188 s3_308 s3_428 s3_548;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server0} ${server10} 'Xf4aGbTaf!' '/mnt' r2 s3_119 s3_239 s3_359 s3_479 s3_599;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server0} ${server11} 'Xf4aGbTaf!' '/mnt' s3_36 s3_156 s3_276 s3_396 s3_516;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server2} ${server12} 'Xf4aGbTaf!' '/mnt' s3_75 s3_195 s3_315 s3_435 s3_555;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server3} ${server13} 'Xf4aGbTaf!' '/mnt' s3_88 s3_208 s3_328 s3_448 s3_568;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server4} ${server14} '' '/mnt' s3_43 s3_163 s3_283 s3_403 s3_523;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server5} ${server15} 'Xf4aGbTaf!' '/mnt' s3_69 s3_189 s3_309 s3_429 s3_549;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server6} ${server16} 'Xf4aGbTaf!' '/mnt' s3_63 s3_183 s3_303 s3_423 s3_543;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server7} ${server17} 'Xf4aGbTaf!' '/mnt' s3_45 s3_165 s3_285 s3_405 s3_525;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server8} ${server18} '' '/mnt' s3_117 s3_237 s3_357 s3_477 s3_597;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server9} ${server19} '' '/mnt' s3_25 s3_145 s3_265 s3_385 s3_505;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server10} ${server20} 'Xf4aGbTaf!' '/mnt' s3_51 s3_171 s3_291 s3_411 s3_531;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server11} ${server21} 'Xf4aGbTaf!' '/mnt' s3_57 s3_177 s3_297 s3_417 s3_537;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server1} ${server22} 'Xf4aGbTaf!' '/mnt' s3_76 s3_196 s3_316 s3_436 s3_556;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server2} ${server23} 'Xf4aGbTaf!' '/mnt' s3_102 s3_222 s3_342 s3_462 s3_582;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server3} ${server24} 'Xf4aGbTaf!' '/mnt' s3_66 s3_186 s3_306 s3_426 s3_546;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server4} ${server25} '' '/mnt' s3_89 s3_209 s3_329 s3_449 s3_569;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server5} ${server26} 'Xf4aGbTaf!' '/mnt' s3_59 s3_179 s3_299 s3_419 s3_539;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server6} ${server27} 'Xf4aGbTaf!' '/mnt' s3_81 s3_201 s3_321 s3_441 s3_561;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server7} ${server28} 'Xf4aGbTaf!' '/mnt' s3_79 s3_199 s3_319 s3_439 s3_559;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server8} ${server29} '' '/mnt' s3_73 s3_193 s3_313 s3_433 s3_553;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server9} ${server30} '' '/mnt' s3_101 s3_221 s3_341 s3_461 s3_581;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server10} ${server31} 'Xf4aGbTaf!' '/mnt' s3_72 s3_192 s3_312 s3_432 s3_552;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server11} ${server32} 'Xf4aGbTaf!' '/mnt' s3_98 s3_218 s3_338 s3_458 s3_578;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server1} ${server33} 'Xf4aGbTaf!' '/mnt' s3_86 s3_206 s3_326 s3_446 s3_566;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server2} ${server34} 'Xf4aGbTaf!' '/mnt' s3_16 s3_136 s3_256 s3_376 s3_496;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server3} ${server35} 'Xf4aGbTaf!' '/mnt' s3_42 s3_162 s3_282 s3_402 s3_522;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server4} ${server36} '' '/mnt' s3_6 s3_126 s3_246 s3_366 s3_486;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server5} ${server37} 'Xf4aGbTaf!' '/mnt' s3_29 s3_149 s3_269 s3_389 s3_509;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server6} ${server38} 'Xf4aGbTaf!' '/mnt' s3_52 s3_172 s3_292 s3_412 s3_532;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server7} ${server39} 'Xf4aGbTaf!' '/mnt' s3_14 s3_134 s3_254 s3_374 s3_494;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server8} ${server40} '' '/mnt' s3_7 s3_127 s3_247 s3_367 s3_487;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server9} ${server41} '' '/mnt' s3_40 s3_160 s3_280 s3_400 s3_520;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server10} ${server42} 'Xf4aGbTaf!' '/mnt' s3_84 s3_204 s3_324 s3_444 s3_564;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server11} ${server43} 'Xf4aGbTaf!' '/mnt' s3_87 s3_207 s3_327 s3_447 s3_567;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server1} ${server44} 'Xf4aGbTaf!' '/mnt' s3_92 s3_212 s3_332 s3_452 s3_572;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server2} ${server45} 'Xf4aGbTaf!' '/mnt' s3_13 s3_133 s3_253 s3_373 s3_493;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server3} ${server46} 'Xf4aGbTaf!' '/mnt' s3_58 s3_178 s3_298 s3_418 s3_538;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server4} ${server47} '' '/mnt' s3_74 s3_194 s3_314 s3_434 s3_554;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server5} ${server48} 'Xf4aGbTaf!' '/mnt' s3_78 s3_198 s3_318 s3_438 s3_558;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server6} ${server49} 'Xf4aGbTaf!' '/mnt' s3_93 s3_213 s3_333 s3_453 s3_573;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server7} ${server50} 'Xf4aGbTaf!' '/mnt' s3_41 s3_161 s3_281 s3_401 s3_521;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server8} ${server51} '' '/mnt' s3_85 s3_205 s3_325 s3_445 s3_565;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server9} ${server52} '' '/mnt' s3_105 s3_225 s3_345 s3_465 s3_585;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server10} ${server53} 'Xf4aGbTaf!' '/mnt' s3_2 s3_122 s3_242 s3_362 s3_482;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server11} ${server54} 'Xf4aGbTaf!' '/mnt' s3_62 s3_182 s3_302 s3_422 s3_542;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server1} ${server55} 'Xf4aGbTaf!' '/mnt' s3_18 s3_138 s3_258 s3_378 s3_498;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server2} ${server56} 'Xf4aGbTaf!' '/mnt' s3_107 s3_227 s3_347 s3_467 s3_587;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server3} ${server57} 'Xf4aGbTaf!' '/mnt' s3_26 s3_146 s3_266 s3_386 s3_506;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server4} ${server58} '' '/mnt' s3_11 s3_131 s3_251 s3_371 s3_491;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server5} ${server59} 'Xf4aGbTaf!' '/mnt' s3_27 s3_147 s3_267 s3_387 s3_507;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server6} ${server60} 'Xf4aGbTaf!' '/mnt' s3_106 s3_226 s3_346 s3_466 s3_586;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server7} ${server61} 'Xf4aGbTaf!' '/mnt' s3_67 s3_187 s3_307 s3_427 s3_547;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server8} ${server62} '' '/mnt' s3_9 s3_129 s3_249 s3_369 s3_489;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server9} ${server63} '' '/mnt' s3_44 s3_164 s3_284 s3_404 s3_524;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server10} ${server64} 'Xf4aGbTaf!' '/mnt' s3_47 s3_167 s3_287 s3_407 s3_527;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server11} ${server65} 'Xf4aGbTaf!' '/mnt' s3_60 s3_180 s3_300 s3_420 s3_540;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server1} ${server66} 'Xf4aGbTaf!' '/mnt' s3_108 s3_228 s3_348 s3_468 s3_588;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server2} ${server67} 'Xf4aGbTaf!' '/mnt' s3_115 s3_235 s3_355 s3_475 s3_595;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server3} ${server68} 'Xf4aGbTaf!' '/mnt' s3_97 s3_217 s3_337 s3_457 s3_577;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server4} ${server69} '' '/mnt' s3_111 s3_231 s3_351 s3_471 s3_591;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server5} ${server70} 'Xf4aGbTaf!' '/mnt' s3_20 s3_140 s3_260 s3_380 s3_500;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server6} ${server71} 'Xf4aGbTaf!' '/mnt' s3_90 s3_210 s3_330 s3_450 s3_570;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server7} ${server72} 'Xf4aGbTaf!' '/mnt' s3_103 s3_223 s3_343 s3_463 s3_583;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server8} ${server73} '' '/mnt' s3_65 s3_185 s3_305 s3_425 s3_545;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server9} ${server74} '' '/mnt' s3_31 s3_151 s3_271 s3_391 s3_511;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server10} ${server75} 'Xf4aGbTaf!' '/mnt' s3_64 s3_184 s3_304 s3_424 s3_544;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server11} ${server76} 'Xf4aGbTaf!' '/mnt' s3_61 s3_181 s3_301 s3_421 s3_541;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server1} ${server77} 'Xf4aGbTaf!' '/mnt' s3_53 s3_173 s3_293 s3_413 s3_533;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server2} ${server78} 'Xf4aGbTaf!' '/mnt' s3_12 s3_132 s3_252 s3_372 s3_492;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server3} ${server79} 'Xf4aGbTaf!' '/mnt' s3_56 s3_176 s3_296 s3_416 s3_536;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server4} ${server80} '' '/mnt' s3_10 s3_130 s3_250 s3_370 s3_490;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server5} ${server81} 'Xf4aGbTaf!' '/mnt' s3_54 s3_174 s3_294 s3_414 s3_534;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server6} ${server82} 'Xf4aGbTaf!' '/mnt' s3_55 s3_175 s3_295 s3_415 s3_535;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server7} ${server83} 'Xf4aGbTaf!' '/mnt' s3_104 s3_224 s3_344 s3_464 s3_584;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server8} ${server84} '' '/mnt' s3_100 s3_220 s3_340 s3_460 s3_580;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server9} ${server85} '' '/mnt' s3_19 s3_139 s3_259 s3_379 s3_499;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server10} ${server86} 'Xf4aGbTaf!' '/mnt' s3_35 s3_155 s3_275 s3_395 s3_515;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server11} ${server87} 'Xf4aGbTaf!' '/mnt' s3_116 s3_236 s3_356 s3_476 s3_596;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server1} ${server88} 'Xf4aGbTaf!' '/mnt' s3_109 s3_229 s3_349 s3_469 s3_589;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server2} ${server89} 'Xf4aGbTaf!' '/mnt' s3_5 s3_125 s3_245 s3_365 s3_485;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server3} ${server90} 'Xf4aGbTaf!' '/mnt' s3_28 s3_148 s3_268 s3_388 s3_508;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server4} ${server91} '' '/mnt' s3_32 s3_152 s3_272 s3_392 s3_512;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server5} ${server92} 'Xf4aGbTaf!' '/mnt' s3_21 s3_141 s3_261 s3_381 s3_501;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server6} ${server93} 'Xf4aGbTaf!' '/mnt' s3_71 s3_191 s3_311 s3_431 s3_551;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server7} ${server94} 'Xf4aGbTaf!' '/mnt' s3_114 s3_234 s3_354 s3_474 s3_594;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server8} ${server95} '' '/mnt' s3_30 s3_150 s3_270 s3_390 s3_510;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server9} ${server96} '' '/mnt' s3_38 s3_158 s3_278 s3_398 s3_518;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server10} ${server97} 'Xf4aGbTaf!' '/mnt' s3_17 s3_137 s3_257 s3_377 s3_497;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server11} ${server98} 'Xf4aGbTaf!' '/mnt' s3_96 s3_216 s3_336 s3_456 s3_576;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server1} ${server99} 'Xf4aGbTaf!' '/mnt' s3_91 s3_211 s3_331 s3_451 s3_571;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server2} ${server100} 'Xf4aGbTaf!' '/mnt' s3_95 s3_215 s3_335 s3_455 s3_575;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server3} ${server101} 'Xf4aGbTaf!' '/mnt' r3 s3_120 s3_240 s3_360 s3_480 s3_600;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server4} ${server102} '' '/mnt' s3_34 s3_154 s3_274 s3_394 s3_514;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server5} ${server103} 'Xf4aGbTaf!' '/mnt' s3_82 s3_202 s3_322 s3_442 s3_562;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server6} ${server104} 'Xf4aGbTaf!' '/mnt' s3_46 s3_166 s3_286 s3_406 s3_526;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server7} ${server105} 'Xf4aGbTaf!' '/mnt' s3_110 s3_230 s3_350 s3_470 s3_590;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server8} ${server106} '' '/mnt' s3_94 s3_214 s3_334 s3_454 s3_574;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server9} ${server107} '' '/mnt' s3_113 s3_233 s3_353 s3_473 s3_593;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server10} ${server108} 'Xf4aGbTaf!' '/mnt' s3_99 s3_219 s3_339 s3_459 s3_579;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server11} ${server109} 'Xf4aGbTaf!' '/mnt' s3_48 s3_168 s3_288 s3_408 s3_528;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server1} ${server110} 'Xf4aGbTaf!' '/mnt' s3_23 s3_143 s3_263 s3_383 s3_503;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server2} ${server111} 'Xf4aGbTaf!' '/mnt' s3_33 s3_153 s3_273 s3_393 s3_513;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server3} ${server112} 'Xf4aGbTaf!' '/mnt' s3_4 s3_124 s3_244 s3_364 s3_484;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server4} ${server113} '' '/mnt' s3_1 s3_121 s3_241 s3_361 s3_481;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server5} ${server114} 'Xf4aGbTaf!' '/mnt' s3_8 s3_128 s3_248 s3_368 s3_488;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server6} ${server115} 'Xf4aGbTaf!' '/mnt' s3_77 s3_197 s3_317 s3_437 s3_557;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server7} ${server116} 'Xf4aGbTaf!' '/mnt' s3_83 s3_203 s3_323 s3_443 s3_563;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server8} ${server117} '' '/mnt' s3_37 s3_157 s3_277 s3_397 s3_517;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server9} ${server118} '' '/mnt' s3_112 s3_232 s3_352 s3_472 s3_592;
...
rm -rf /mnt/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/mnt/fetch.sh /mnt/
cd /mnt && sh -x fetch.sh ${server10} ${server119} 'Xf4aGbTaf!' '/mnt' s3_49 s3_169 s3_289 s3_409 s3_529;
...
(
echo "[$server9]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server9 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server12]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server12 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server16]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server16 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server22]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server22 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server23]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server23 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server26]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server26 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server29]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server29 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server30]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server30 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server31]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server31 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server33]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server33 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server46]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server46 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server51]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server51 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server52]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server52 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server60]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server60 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server61]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server61 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server65]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server65 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server67]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server67 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server71]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server71 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server76]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server76 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server94]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server94 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server100]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server100 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server103]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server103 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server105]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server105 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server106]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server106 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server107]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server107 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server108]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server108 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server115]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server115 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
...
(
echo "[$server118]"
sshpass -p '' ssh -f -o StrictHostKeyChecking=no root@$server118 bash -c "'\
export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/usr/local/gcc-8.3.0/lib64; \
