...
cd /root/xf && sh -x fetch.sh ${server0} ${server1} 'Xf4aGbTaf!' '/root/xf' s3_7 s3_27 s3_47 s4_17 s4_37;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server2} 'Xf4aGbTaf!' '/root/xf' s3_4 s3_24 s3_44 s4_14 s4_34;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server3} 'Xf4aGbTaf!' '/root/xf' s3_17 s3_37 s4_7 s4_27 s4_47;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server4} 'Xf4aGbTaf!' '/root/xf' s3_6 s3_26 s3_46 s4_16 s4_36;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server5} 'Xf4aGbTaf!' '/root/xf' s3_13 s3_33 s4_3 s4_23 s4_43;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server6} 'Xf4aGbTaf!' '/root/xf' s3_9 s3_29 s3_49 s4_19 s4_39;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server7} 'Xf4aGbTaf!' '/root/xf' r2 s3_19 s3_39 s4_9 s4_29 s4_49;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server8} 'Xf4aGbTaf!' '/root/xf' s3_14 s3_34 s4_4 s4_24 s4_44;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server9} 'Xf4aGbTaf!' '/root/xf' s3_11 s3_31 s4_1 s4_21 s4_41;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server10} 'Xf4aGbTaf!' '/root/xf' s3_10 s3_30 s3_50 s4_20 s4_40;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server11} 'Xf4aGbTaf!' '/root/xf' s3_5 s3_25 s3_45 s4_15 s4_35;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server12} 'Xf4aGbTaf!' '/root/xf' s3_1 s3_21 s3_41 s4_11 s4_31;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server13} 'Xf4aGbTaf!' '/root/xf' s3_3 s3_23 s3_43 s4_13 s4_33;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server14} 'Xf4aGbTaf!' '/root/xf' s3_16 s3_36 s4_6 s4_26 s4_46;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server15} 'Xf4aGbTaf!' '/root/xf' s3_2 s3_22 s3_42 s4_12 s4_32;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server16} 'Xf4aGbTaf!' '/root/xf' s3_8 s3_28 s3_48 s4_18 s4_38;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server17} 'Xf4aGbTaf!' '/root/xf' s3_15 s3_35 s4_5 s4_25 s4_45;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server18} 'Xf4aGbTaf!' '/root/xf' s3_12 s3_32 s4_2 s4_22 s4_42;
...
rm -rf /root/xf/zjnodes;
sshpass -p 'Xf4aGbTaf!' scp -o StrictHostKeyChecking=no root@"${server0}":/root/xf/fetch.sh /root/xf/
cd /root/xf && sh -x fetch.sh ${server0} ${server19} 'Xf4aGbTaf!' '/root/xf' r3 s3_20 s3_40 s4_10 s4_30 s4_50;
