...
cd /root && sh -x fetch.sh 127.0.0.1 ${server0} '' '/root' r1 r2 r3 s3_1 s3_2 s3_3 s3_4 s3_5 s4_1 s4_2 s4_3 s4_4 s4_5
echo "==== 同步中继服务器 ====" 
wait

(
echo "[$server0]"
for n in r1 r2 r3 s3_1 s3_2 s3_3 s3_4 s3_5 s4_1 s4_2 s4_3 s4_4 s4_5; do
